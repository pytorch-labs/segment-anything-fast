...
for bs, model in itertools.product([1, 32], ["vit_b", "vit_h"]):
    ...
    run_experiment("static_int8","local-fork",                  model, bs, 32, limit=20*bs, use_half=True,  use_compile="max-autotune-no-cudagraphs", use_nested_tensor=(bs > 1), compress="static_quant", capture_output=False)
