...
run_experiment("0180",  "codesign",                    "vit_b", 60, 32, use_half=True,  use_compile="max-autotune", print_header=True)
run_experiment("0180",  "sdpa-decoder",                "vit_b", 60, 32, use_half=True,  use_compile="max-autotune")
run_experiment("0181",  "local-fork",                  "vit_b", 60, 32, use_half=True,  use_compile="max-autotune")
run_experiment("0182",  "local-fork",                  "vit_b", 60, 32, use_half=True,  use_compile="max-autotune", use_nested_tensor=True)
run_experiment("0183",  "local-fork",                  "vit_b", 60, 32, use_half=True,  use_compile="max-autotune", use_nested_tensor=True, compress="dynamic_quant")
run_experiment("0184",  "local-fork",                  "vit_b", 60, 32, use_half=True,  use_compile="max-autotune", use_nested_tensor=True, compress="dynamic_quant_sparse")

run_experiment("1170",  "codesign",                    "vit_h", 40, 32, use_half=True,  use_compile="max-autotune")
run_experiment("1170",  "sdpa-decoder",                "vit_h", 40, 32, use_half=True,  use_compile="max-autotune")
run_experiment("1171",  "local-fork",                  "vit_h", 40, 32, use_half=True,  use_compile="max-autotune")
run_experiment("1172",  "local-fork",                  "vit_h", 40, 32, use_half=True,  use_compile="max-autotune", use_nested_tensor=True)
run_experiment("1173",  "local-fork",                  "vit_h", 40, 32, use_half=True,  use_compile="max-autotune", use_nested_tensor=True, compress="dynamic_quant")
run_experiment("1174",  "local-fork",                  "vit_h", 40, 32, use_half=True,  use_compile="max-autotune", use_nested_tensor=True, compress="dynamic_quant_sparse")
