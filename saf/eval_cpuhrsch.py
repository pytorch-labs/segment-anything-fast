...
for bs, model in itertools.product([32], ["vit_b", "vit_h"]):
    ...
    run_experiment("int8",       "local-fork",                  model, bs, 32, limit=bs, use_half=True,  use_compile="max-autotune", use_nested_tensor=(bs > 1), compress="dynamic_quant", capture_output=False)
