...
# run_traces("bf16",           "codesign",                    "vit_b", 16, 32, use_half=True)
...
# run_traces("Triton",             "local-fork",                  "vit_b", 16, 32, use_half=True,  use_compile="max-autotune", use_nested_tensor=True, compress="dynamic_quant", use_triton_sdpa_plus=True, capture_output=False)
# run_traces("sparse",             "local-fork",                  "vit_b", 16, 32, use_half=True,  use_compile="max-autotune", use_nested_tensor=True, compress="int4_dynamic_quant_sparse", use_triton_sdpa_plus=True)
...
for bs in [1, 32, 64, 128]:
    ...
    run_experiment("int8",       "local-fork",                  "vit_b", bs, 32, use_half=True,  use_compile="max-autotune", compress="dynamic_quant")
    run_experiment("Triton",     "local-fork",                  "vit_b", bs, 32, use_half=True,  use_compile="max-autotune", compress="dynamic_quant", use_triton_sdpa_plus=True)
    run_experiment("sparse",     "local-fork",                  "vit_b", bs, 32, use_half=True,  use_compile="max-autotune", compress="int4_dynamic_quant_sparse", use_triton_sdpa_plus=True)
    run_experiment("NT",         "local-fork",                  "vit_b", bs, 32, use_half=True,  use_compile="max-autotune", use_nested_tensor=True, compress="int4_dynamic_quant_sparse", use_triton_sdpa_plus=True)
    ...
    run_experiment("int8",       "local-fork",                  "vit_l", bs, 32, use_half=True,  use_compile="max-autotune", compress="dynamic_quant")
    run_experiment("Triton",     "local-fork",                  "vit_l", bs, 32, use_half=True,  use_compile="max-autotune", compress="dynamic_quant", use_triton_sdpa_plus=True)
    run_experiment("sparse",     "local-fork",                  "vit_l", bs, 32, use_half=True,  use_compile="max-autotune", compress="int4_dynamic_quant_sparse", use_triton_sdpa_plus=True)
    run_experiment("NT",         "local-fork",                  "vit_l", bs, 32, use_half=True,  use_compile="max-autotune", use_nested_tensor=True, compress="int4_dynamic_quant_sparse", use_triton_sdpa_plus=True)
    ...
    run_experiment("int8",       "local-fork",                  "vit_h", bs, 32, use_half=True,  use_compile="max-autotune", compress="dynamic_quant")
    run_experiment("Triton",     "local-fork",                  "vit_h", bs, 32, use_half=True,  use_compile="max-autotune", compress="dynamic_quant", use_triton_sdpa_plus=True)
    run_experiment("sparse",     "local-fork",                  "vit_h", bs, 32, use_half=True,  use_compile="max-autotune", compress="int4_dynamic_quant_sparse", use_triton_sdpa_plus=True)
    run_experiment("NT",         "local-fork",                  "vit_h", bs, 32, use_half=True,  use_compile="max-autotune", use_nested_tensor=True, compress="int4_dynamic_quant_sparse", use_triton_sdpa_plus=True)
