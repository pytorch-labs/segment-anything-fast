...
sam_path = os.path.join(home, "misc/segment-anything")
sam_commits = {
...
root_cmd = [python_path, script_path,
            "--coco_root_dir",
            os.path.join(home, "misc/coco"),
            "--coco_slice_name",
            "val2017",
            "--sam_checkpoint_base_path",
            os.path.join(home, "misc/sam_checkpoints"),
            "--sam_model_type",
            "vit_b",
...
run_experiment("131",  "predict-masks-nested", "vit_b", 2, 0, use_half=True,  use_compile="default", use_nested_tensor=True, capture_output=False)
